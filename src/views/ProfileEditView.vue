        ...
        <nav class="navbar navbar-light navbar-expand-lg mx-0">
          ...
          >
            ...
            <div class="offcanvas-body p-0">
              ...
              <div class="card w-100">
                ...
                <div class="card-body">
                  ...
                  >
                    <li class="nav-item" data-bs-dismiss="offcanvas">
                      <a
                        class="nav-link d-flex mb-0 active"
                    ...
                    <li class="nav-item" data-bs-dismiss="offcanvas">
                      ...
                      >
                        <img
                          ...
                          alt=""
                        /><span>Privacy and safety </span></a
                      >
                    </li>
                    <li class="nav-item" data-bs-dismiss="offcanvas">
                      <a
                ...
                <div class="card-footer text-center py-2">
                  <a class="btn btn-link text-secondary btn-sm" href="#!"
                    >Logout
                  </a>
                </div>
              </div>
            ...
            <p class="small text-center mt-1">
              ©2022
              <a class="text-body" target="_blank" href=""> Fian </a>
            </p>
          </div>
        </nav>
      </div>
          ...
          <div class="tab-pane show active fade" id="nav-setting-tab-1">
            ...
            <div class="card mb-4">
              ...
              <div class="card-header border-0 pb-0">
                <h1 class="h5 card-title">Edit Profile</h1>
              </div>
              <!-- Card header START -->
              <!-- Card body START -->
              <div class="card-body">
                <!-- Form settings START -->
                <form
                  @submit.prevent="handleEditProfile(this.profile)"
                  class="row g-3"
            ...
            <div class="card">
              ...
              <!-- <div class="accordion-item bg-transparent">
                        <h2 class="accordion-header" id="flush-headingOne">
                          ...
                          >
                            <span>
                              <span class="mb-0 h6 d-block"
                                >Email notifications</span
                              >
                              <small class="small mb-0 text-secondary"
                  ...
                  >
                    <div class="me-2">
                      <h6 class="mb-0">
                        ...
                        <span class="badge bg-primary smaller"> Pro only</span>
                      </h6>
                      <p class="small mb-0">
                        Rendered six say his striking confined.
                      </p>
            ...
            <div class="card">
                          ...
                          >
                            <div class="me-2">
                              ...
                              <p class="small">
                                ...
                                marketing partners unless you respond to their
                                Sponsored Messages
                              </p>
                            </div>
                            <div class="form-check form-switch">
              ...
              <!-- <li
                          ...
                          >
                            <div class="me-2">
                              <p class="mb-0">
                                Allow people to search by your email address?
                              </p>
                            </div>
                            <div class="form-check form-switch">
                              <input
